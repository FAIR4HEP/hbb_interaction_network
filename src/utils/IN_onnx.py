...
def main(args):
    ...
    params_sv = params_3
    label = "new"
    from gnn import GraphNet, GraphNetnoSV
    ...
    if args.sv_branch:
        ...
        gnn = GraphNetnoSV(N, n_targets, len(params), args.hidden, De=args.De, Do=args.Do, softmax=True)
    ...
    ort_inputs = {
        ort_session.get_inputs()[0].name: to_numpy(dummy_input_1),
