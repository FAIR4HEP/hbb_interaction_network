...
gnn_0 = GraphNet(60, 2, len(params), 60, 5, len(params_sv), vv_branch=0, De=20, Do=24)
...
torch.onnx.export(
    ...
    dynamic_axes={input_names[0]: {0: "batch_size"}, input_names[1]: {0: "batch_size"}, output_names[0]: {0: "batch_size"}},
)
